...
Regenerate the PNG (300 dpi), PDF, and SVG with:
...
`figures/`. PDF embeds fonts and SVG retains text for further vector editing.
...
300-dpi PNG and editable PDF/SVG with:
